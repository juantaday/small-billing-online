...
import { IWithholding, IWithholdingItem } from '@sri/core';

export function buildWithholdingXml(data: IWithholding): string {
  ...
  data.items.forEach((item: IWithholdingItem) => {

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Sistema profesional de gestión de ventas y facturación para comidas rápidas. 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <span>contacto@fastfood.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-600 dark:text-gray-400 text-center md:text-left">
              © {currentYear} FastFood System. Todos los derechos reservados.
            </p>
